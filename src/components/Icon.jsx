/**
 * Icon — inline SVG icons from Lucide (https://lucide.dev), ISC-licensed.
 *
 * Lucide (a fork of Feather) is ISC/MIT — free for commercial use with
 * NO attribution requirement. We inline the path data (24×24 viewBox,
 * stroke-based) rather than pull a runtime dependency, so icons:
 *   - inherit the theme via `stroke="currentColor"` (recolour for free
 *     across cream / dark × free / Pro, and match whatever text colour
 *     the button/label uses),
 *   - scale crisply at any size,
 *   - add zero bytes of external request (CSP-safe, works offline),
 *   - carry no licence/attribution burden.
 *
 * Usage:  <Icon name="plus" />            (16px, inherits colour)
 *         <Icon name="settings" size={18} strokeWidth={1.75} />
 *
 * Add an icon: copy its inner markup from lucide.dev as JSX into PATHS.
 */

// Inner SVG markup per icon (everything inside the <svg>). Sourced from
// lucide.dev. Keep names kebab-case to match Lucide's own naming.
const PATHS = {
  // Travel / holiday planner set
  compass: <><path d="m16.24 7.76-1.804 5.411a2 2 0 0 1-1.265 1.265L7.76 16.24l1.804-5.411a2 2 0 0 1 1.265-1.265z" /><circle cx="12" cy="12" r="10" /></>,
  beer: <><path d="M17 11h1a3 3 0 0 1 0 6h-1" /><path d="M9 12v6" /><path d="M13 12v6" /><path d="M14 7.5c-1 0-1.44.5-3 .5s-2-.5-3-.5-1.72.5-2.5.5a2.5 2.5 0 0 1-.7-4.9 4 4 0 0 1 6.4-1.1 4 4 0 0 1 6.4 1.1 2.5 2.5 0 0 1-.7 4.9c-.78 0-1.72-.5-2.5-.5Z" /><path d="M5 8v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V8" /></>,
  ...
  'square-check-big': <><path d="M21 10.656V19a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h9.344" /><path d="m9 11 3 3L22 4" /></>,
  ...
  // ── Batch: chrome icons for the app-wide emoji sweep ──
  ...
  /* The coin. A hexagon rather than a circle, because the app has said
     "⬡" everywhere it has ever mentioned coins and a circle would read
     as a different currency. */
  coin: <><path d="M12 2.5 20.5 7.25v9.5L12 21.5 3.5 16.75v-9.5z" /><path d="M12 7.5 16.5 10v4L12 16.5 7.5 14v-4z" /></>,
  ...
  'piggy-bank': <><path d="M11 17h3v2a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1v-3a3.16 3.16 0 0 0 2-2h1a1 1 0 0 0 1-1v-2a1 1 0 0 0-1-1h-1a5 5 0 0 0-2-3V4a4 4 0 0 0-3.2 1.6l-.3.4H11a6 6 0 0 0-6 6v1a5 5 0 0 0 2 4v2a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1z" /><path d="M16 10h.01" /><path d="M2 8v1a2 2 0 0 0 2 2h1" /></>,
